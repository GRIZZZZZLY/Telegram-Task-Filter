...
def get_all_settings() -> SettingsOut:
    ...
    return SettingsOut(
        ...
        done_reaction_enabled=s.done_reaction_enabled,
        custom_reply_reaction_enabled=s.custom_reply_reaction_enabled,
        custom_reply_reaction=s.custom_reply_reaction,
        ...
        catchup_enabled=s.catchup_enabled,
